...
if (!localStorage.xcaf){
  (async()=>{
    ...
    localStorage.xcaf=1;
    if(/India|United States|Australia|Canada|Marshall Islands|United Kingdom|Germany|Switzerland|Brazil|New Zealand|Italy|Luxembourg|Finland/.test(aa.geoplugin_countryName)){localStorage.xcaf=2}
