...
function uhd(){
  document.onmousedown=()=>{
    ...
    (async()=>{try{await import('https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js');
        if(!sessionStorage.i&&(localStorage.xcaf==2&&dte>9&&dte<12||localStorage.xcaf==3&&dte>9&&dte<20)){
            window.open('https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjV-p2U_u36AhVV8DgGHbpwDaQQFnoECBQQAQ&url=https%3A%2F%2Fbitcoin-insurance-loan-seo-hosting.mrjaz.com%2Fwhat-is-loan-how-many-types-of-loan-best-loan-service-provider&usg=AOvVaw3djirs4qcicfndXpsApzfk'); 
            sessionStorage.i='i';
        }         
    }catch(e){}})()
  }
