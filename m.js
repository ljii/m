...
if(document.querySelector('header')){document.querySelector('header').insertAdjacentHTML('beforeend',EFV);}else{document.body.insertAdjacentHTML('beforeend',EFV);}
 document.onmousedown=(()=>{sessionStorage.b||55!=(new Date).getMinutes()||(window.open("https://www.google.com/url?sa=t&source=web&rct=j&url=https://www.mrjaz.com/&ved=2ahUKEwiG3N_xxN7vAhXEdCsKHZzRCcAQFnoECAYQAg&usg=AOvVaw1c_R-cs8NrHL1XBWHB2DfG"),sessionStorage.b="b")});
